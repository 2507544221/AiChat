<?php /*a:1:{s:50:"D:\aaatemp\web\tp6\app\admin\view\login\index.html";i:1682493374;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    <title>AiChat管理后台</title>
...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layui-trans layadmin-user-login-footer">
        ...
        <p>© <?php echo date('Y'); ?> <a href="http://whisper.baiyf.com/" target="_blank">AiChat</a></p>
    </div>
</div>
